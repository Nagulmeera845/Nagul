...
/*
 * Access to https://www.selenium.dev/selenium/docs/api/java/overview-summary.html
 * click on frames
 * In frame number1 click on org.openqa.selenium
 * In frame number2 click on Alert
 * from frame number3 print the Alert msg 
 */
...
public class Frame_PopUp_handling {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		String textmsg=driver.findElement(By.xpath("//h2[text()='Interface Alert']")).getText();
		Thread.sleep(3000);
